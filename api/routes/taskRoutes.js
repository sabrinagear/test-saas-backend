...
//             item.name
//           } to the ${notification.groupName} shopping list.`

//           pusher.trigger(`group-${groupID}`, 'add-item', {
//             message: `${notification.userName} added ${item.name} to the ${
...
//             return res
//               .status(200)
//               .json({ message: `Item successfully added`, id: id[0] })
//           })
//         })
//       })
//     })
...
//       return res
//         .status(404)
//         .json({ message: 'The requested item does not exist.' })
//     })
//     .catch(err => {
//       const error = {
...
//       return res
//         .status(404)
//         .json({ message: `The requested items do not exist.` })
//     })
//     .catch(err => {
//       const error = {
...
//                 oldItem.name
//               } from the ${notification.groupName} shopping list.`
...
//                 return res
//                   .status(200)
//                   .json({ message: 'Item removed successfully', id: status[0] })
//               })
//             })
//           })
//         } else {
